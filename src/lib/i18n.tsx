...
const STRINGS: Record<Lang, Dict> = {
  ...
  TA: {
    ...
    "page.assistant.subtitle": "பின்தளத்தில் இயங்கும் AI விவசாய ஆலோசனை · உங்கள் மொழியில் பதில்கள்",
  ...
  TE: {
    ...
    "page.assistant.subtitle": "బ్యాక్‌ఎండ్ ఆధారిత AI వ్యవసాయ సలహా · మీ భాషలో జవాబులు",
